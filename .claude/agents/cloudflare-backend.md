...
description: <what the worker must do or change>
acceptance:
...
5. Ensure each file remains **≤ 100 TypeScript lines** (aim for 20 – 80).
6. Use `console.error` freely for observability; no shared frontend error utilities.
